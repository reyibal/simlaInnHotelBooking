            ...
            <select class="form-select shadow-none" name="adult">
              <?php 
                $guests_q = mysqli_query($con,"SELECT MAX(adult)  AS `max_adult` , 
                  MAX(children) as `max_children` FROM `rooms` WHERE `status`='1' AND `removed`='0'");
        ...
        echo <<<data
          ...
          <div class="col-lg-4 col-md-6 my-3">
            <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
              <img src="$room_thumb" class="card-img-top" alt="room-1">
              <div class="card-body">
                <h5>$room_data[name]</h5>
                <h6 class="mb-4">LKR $room_data[price] night</h6>
          ...
          while($row = mysqli_fetch_assoc($review_res))
          {
            ...
            <div class="swiper-slide bg-white p-4">
              <div class="profile d-flex align-items-center mb-3">
                <img src="$img_path$row[profile]" class="rounded" loading="lazy" width="30px">
