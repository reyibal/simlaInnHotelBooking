...
if(isset($_POST['booking_analytics']))
{
   ...
   $result = mysqli_fetch_assoc(mysqli_query($con,"SELECT
        ...
        SUM(CASE WHEN booking_status != 'pending' AND booking_status != 'payment failed' THEN `trans_amount` END) AS `total_amt`,
        ...
        SUM(CASE WHEN booking_status = 'cancelled' AND refund=1 THEN `trans_amount` END) AS `cancelled_amt`
