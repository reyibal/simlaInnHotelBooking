        ...
        <div class="bg-white rounded shadow p-4">
          ...
          <?php 
            if($contact_r['twitter']!=''){
              echo<<<data
                <a href="$contact_r[twitter]" target="_blank" class="d-inline-block test-dark fs-5 me-2">
          ...
          <a href="<?php echo $contact_r['facebook']?>" target="_blank" class="d-inline-block test-dark fs-5 me-2"> 
            <i class="bi bi-facebook"></i>
          </a>
          <a href="<?php echo $contact_r['instagram']?>" target="_blank" class="d-inline-block test-dark fs-5">
