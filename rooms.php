            ...
            <nav class="navbar navbar-expand-lg  navbar-light bg-white rounded shadow">
              <div class="container-fluid flex-lg-column align-items-stretch">
                ...
                <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="filterDropdown">
                  <!-- Check availaiblity button -->
                  <div class="border bg-light p-3 rounded mb-3">
                    <h5 class="d-flex align-items justify-content-between mb-3" style="font-size: 18px;">
                  ...
                  <div class="border bg-light p-3 rounded mb-3">
                    ...
                    <div class="d-flex">
                      <div class="me-2">
                        ...
                        <input type="number" min="1" id="adults" value="<?php echo $adult_default ?>" oninput="guests_filter()" class="form-control shadow-none mb-3">
                      </div>
                      <div>
  ...
  <script>
    ...
    function fetch_rooms() 
    {
      ...
      xhr.onprogress = function () {
        rooms_data.innerHTML = `<div class="spinner-border text-success mb-3 d-block mx-auto" id="loader" role="status">
